...
@php
    ...
    $addPermGroups = [
        'Tasks & Work'    => ['icon'=>'fa-square-check','color'=>'#6366F1','bg'=>'#EEF2FF','perms'=>['view_tasks'=>'View Tasks','submit_work'=>'Submit Work','manage_tasks'=>'Manage Tasks','delete_tasks'=>'Delete Tasks','approve_tasks'=>'Approve Submissions','view_activity_log'=>'Activity Log','view_version_history'=>'Version History','view_comments'=>'Comments']],
