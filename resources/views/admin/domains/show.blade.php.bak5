...
<div x-data="{ editModal: false, deleteModal: false, showPass: false }">
    ...
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-bottom:20px;">
        <div class="info-card" style="text-align:center;">
            ...
            <div style="font-size:11px;color:#9CA3AF;margin-top:2px;">{{ number_format($domain->cost, 3) }} {{ $domain->currency }} / {{ $billingCycles[$domain->billing_cycle] ?? $domain->billing_cycle }}</div>
            @endif
            @else
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px;">
                    ...
                    <div>
                        ...
                        <div style="display:flex;align-items:center;gap:8px;">
                            ...
                            <span class="info-value">{{ $domain->responsibleUser->name }}</span>
                        </div>
                        @else
                        <div class="info-value" style="color:#9CA3AF;">Not assigned</div>
                        @endif
            ...
            <div class="info-card" style="background:linear-gradient(135deg,#EEF2FF,#F5F3FF);border-color:#C7D2FE;">
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
                    <div style="background:#fff;border-radius:10px;padding:12px;border:1px solid #E0E7FF;">
                        ...
                        <div style="font-size:11px;color:#6B7280;">{{ $domain->currency }} / {{ $billingCycles[$domain->billing_cycle] ?? $domain->billing_cycle }}</div>
                    </div>
                    <div style="background:#fff;border-radius:10px;padding:12px;border:1px solid #E0E7FF;">
