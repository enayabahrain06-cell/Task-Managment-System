...
/* ── Hero strip ── */
.hero-tbl  { width:100%; border-collapse:collapse; margin-bottom:14px; }
...
<table class="hero-tbl">
    <tr>
        {{-- LEFT: Total --}}
        <td class="hero-left">
            <div class="hero-lbl">Total Accounts</div>
            ...
            <span class="hero-pill" style="background:rgba(255,255,255,.13);color:rgba(255,255,255,.75);">{{ $summary['inactive'] }} inactive</span>
            <span class="hero-pill" style="background:rgba(255,255,255,.10);color:rgba(255,255,255,.6);">{{ $summary['suspended'] }} suspended</span>
        </td>
            ...
            <table width="100%" style="border-collapse:collapse;">
                <tr>
                    ...
                    <td class="stat-cell">
                        ...
                        <div class="stat-num">{{ $summary['inactive'] }}</div>
                        <div class="stat-sub">Not in use</div>
                    </td>
                    <td class="stat-cell">
                        <div class="stat-lbl">Suspended</div>
                        <div class="stat-num">{{ $summary['suspended'] }}</div>
