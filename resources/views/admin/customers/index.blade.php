...
@section('content')
<script>
window._custSummaryInit = null; // loaded async via fetchSummary() on init
...
<div x-data="{
    ...
    {{-- Summarize Modal --}}
    <div x-show="summarizeModal" x-cloak
         style="position:fixed;inset:0;z-index:2000;"
         @keydown.escape.window="summarizeModal=false">
        ...
        <div x-transition:enter="transition ease-out duration-200"
            ...
            <div style="padding:20px 24px 18px;border-bottom:1px solid #F3F4F6;display:flex;align-items:center;justify-content:space-between;flex-shrink:0;gap:12px;flex-wrap:wrap;">
                <div style="display:flex;align-items:center;gap:10px;">
                    <div style="width:36px;height:36px;border-radius:10px;background:linear-gradient(135deg,#6366F1,#8B5CF6);display:flex;align-items:center;justify-content:center;">
                        <i class="fas fa-chart-pie" style="font-size:14px;color:#fff;"></i>
                    </div>
                    <div>
                ...
                <div style="display:flex;align-items:center;gap:8px;flex-shrink:0;">
                    ...
                    <button @click="summarizeModal=false" type="button"
                            style="width:30px;height:30px;border-radius:8px;background:#F3F4F6;border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;color:#6B7280;font-size:13px;">
                        <i class="fas fa-times"></i>
                    </button>
                </div>
