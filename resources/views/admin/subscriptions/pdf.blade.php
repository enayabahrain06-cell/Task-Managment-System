...
.stat-lbl  { font-size:6px; font-weight:700; text-transform:uppercase; letter-spacing:.1em; margin-bottom:5px; }
.stat-num  { font-size:26px; font-weight:800; line-height:1; margin-bottom:4px; }
.stat-sub  { font-size:6.5px; }
...
<table class="hero-tbl" style="margin-bottom:6px;">
    <tr>
        {{-- LEFT: Total --}}
        <td class="hero-left">
            <div class="hero-lbl">Total Subscriptions</div>
        ...
        <td class="hero-right">
            <table width="100%" style="border-collapse:collapse;">
                <tr>
                    <td class="stat-cell">
                        <div class="stat-lbl" style="color:rgba(255,255,255,.5);">Active</div>
                        <div class="stat-num" style="color:#fff;">{{ $summary['active'] }}</div>
                        <div class="stat-sub" style="color:rgba(255,255,255,.4);">Currently running</div>
                    </td>
                    <td class="stat-cell">
                        <div class="stat-lbl" style="color:rgba(255,255,255,.5);">Expiring Soon</div>
                        <div class="stat-num" style="color:#fff;">{{ $summary['expiring_soon'] }}</div>
                        <div class="stat-sub" style="color:rgba(255,255,255,.4);">Within 30 days</div>
                    </td>
                    <td class="stat-cell">
                        <div class="stat-lbl" style="color:rgba(255,255,255,.5);">Expired</div>
                        <div class="stat-num" style="color:#fff;">{{ $summary['expired'] }}</div>
                        <div class="stat-sub" style="color:rgba(255,255,255,.4);">Action needed</div>
                    </td>
                </tr>
            </table>
        </td>
