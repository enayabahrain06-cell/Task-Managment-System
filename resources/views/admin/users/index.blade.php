...
{{-- Header --}}
<div class="users-page-header flex items-center justify-between mb-6">
    <div>
...
{{-- Tabs --}}
<div class="users-tabs-wrap mb-6">
...
{{-- Search & Filters --}}
<form method="GET" action="{{ route('admin.users.index') }}" class="users-filter-form flex flex-wrap gap-3 mb-4">
...
<div x-data="permsApp()" x-init="init()" class="perms-layout" style="display:flex;gap:20px;height:calc(100vh - 230px);min-height:540px;">

    {{-- ── Left panel: user list ── --}}
    <div class="perms-sidebar" style="width:272px;flex-shrink:0;background:#fff;border-radius:16px;border:1px solid #E5E7EB;overflow:hidden;display:flex;flex-direction:column;box-shadow:0 1px 4px rgba(0,0,0,.05);">
